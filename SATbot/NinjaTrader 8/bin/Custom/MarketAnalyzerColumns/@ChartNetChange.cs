...
namespace NinjaTrader.NinjaScript.MarketAnalyzerColumns
{
	...
	public class ChartNetChange : Gui.NinjaScript.MarketAnalyzerColumnRenderBase
	{
		...
		private double			settlementOrLastClose	= double.MinValue;
		...
		protected override void OnMarketData(Data.MarketDataEventArgs marketDataUpdate)
		{
			...
			else if (marketDataUpdate.MarketDataType != Data.MarketDataType.Last || (marketDataUpdate.Instrument.MarketData.LastClose == null && marketDataUpdate.Instrument.MarketData.Settlement == null))
				return;
		...
		public override void OnRender(DrawingContext dc, System.Windows.Size renderSize)
		{
			...
			double					previousClose		= !isInSession && firstIdx > 0 ? BarsArray[0].GetClose(firstIdx - 1) : settlementOrLastClose;
